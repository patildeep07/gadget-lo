...
export const Store = () => {
  ...
  const { filterByPriceLowToHigh, filterByPriceHighToLow, loading } = allData;
          ...
          <div className="filters-section">
            ...
            <div>
              <div className="flex-row">
                <h3>PRICE</h3>
                <button
                  onClick={() => setAllData({ type: "CLEAR_PRICE_FILTER" })}
                >
                  Clear
                </button>
              </div>
            ...
            <div>
              <div className="flex-row">
                <h3>PRICE RANGE</h3>
                <button
                  onClick={() => setAllData({ type: "CLEAR_PRICE_RANGE" })}
                >
                  Clear
                </button>
              </div>
            ...
            <div>
              ...
              <div className="input-div">
                <input
                  ...
                  checked={
                    allData.filterByCategories.includes("Television")
                      ? true
                      : false
                  }
                />
            ...
            {storeList.length > 0 && (
              <div className="products-section">
                {storeList.map((product) => {
                  return (
                    <DisplayProductCards item={product} key={product._id} />
                  );
                })}
              </div>
            )}
